...
import 'html-escaper';
/* empty css                           *//* empty css                               *//* empty css                         *//* empty css                           *//* empty css                           *//* empty css                                 */import { useState, useEffect } from 'react';
import { jsx, jsxs } from 'react/jsx-runtime';
/* empty css                                 */import { Tooltip } from 'react-tooltip';
...
const $$LanguageButton = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <a${addAttribute(`bg-[#3450A2] dark:bg-[#3450A2] text-white dark:text-white px-4 py-2 cursor-pointer hover:ring-2 hover:ring-stone-300 dark:hover:ring-2 dark:hover:ring-white outline-none font-medium transition-all rounded-md`, "class")}${addAttribute(isEnglish ? "/en/" : "/", "href")}>
    ${isEnglish ? "Espa\xF1ol" : "English"}
  </a>
</div>`;
...
const $$Navbar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<header class="Navbar bg-white flex items-center flex-col gap-2 m-auto sm:flex-row sm:place-content-between max-w-6xl px-7 py-3 rounded-xl dark:text-white dark:bg-[#272D40] duration-300 astro-5BLMO7YK">
    ...
    <div class="flex items-center gap-4 astro-5BLMO7YK">
        ${renderComponent($$result, "DvButton", DvButton, { "text": "CV", "class": "astro-5BLMO7YK" })}
        ${renderComponent($$result, "LanguageButton", $$LanguageButton, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/Programming/portfolio/src/components/LanguageButton.astro", "client:component-export": "default", "class": "astro-5BLMO7YK" })}
