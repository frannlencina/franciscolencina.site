/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderComponent, e as renderSlot, f as renderHead } from '../astro.83711a80.mjs';
import 'html-escaper';
/* empty css                         *//* empty css                         */
        ...
        <div class="flex justify-between">
            <div class="max-w-[70%]">
                ...
                <p class="opacity-50 font-light mt-2">
                    Si quieres contactarme para contratar alguno de mis servicios,
                    colaborar en algun proyecto charlar o consultar alguna duda
                    puedes hacerlo en los siguientes lugares
                </p>
                <div class="flex gap-4 font-bold mt-5">
                    <a${addAttribute(defaultStyle, "class")} href="">twitter-x</a><span>/</span><a${addAttribute(defaultStyle, "class")} href="">linkedin</a><span>/</span><a${addAttribute(defaultStyle, "class")} href="">github</a><span>/</span><a${addAttribute(defaultStyle, "class")} href="">@gmail.com</a>
                </div>
            </div>
    
            <div class="flex items-end gap-2 text-xl">
                <button class="opacity-40 hover:opacity-100"><i class="ri-moon-line"></i></button>
                <button class="opacity-40 hover:opacity-100"> <i class="ri-sun-line"></i></button>
                <button class="opacity-40 hover:opacity-100"> <i class="ri-computer-line"></i></button>
            </div>
        </div>
...
export { $$Footer as $, _404 as _, $$Layout as a };
